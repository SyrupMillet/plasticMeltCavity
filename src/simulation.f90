...
contains
   ...
   !> Function that locolizes the top
   ...
   subroutine simulation_init
      ...
      create_and_initialize_flow_solver: block
         ...
         call param_read('Melt dynamic viscosity',fs%visc_l)
         call param_read('Liquid dynamic viscosity',fs%visc_g)
         ! Assign constant density to each phase
         call param_read('Melt density',fs%rho_l)
         call param_read('Liquid density',fs%rho_g)
         ...
         ! read cavity velocity
         call param_read('Cavity velocity',cavityU, default=0.0_WP)
      ...
      create_ensight: block
         ...
         ens_out=ensight(cfg=cfg,name='Cavity_Particle')
